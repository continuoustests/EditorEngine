...
namespace EditorClient
{
	public class Arguments
	{
		...
		public static Arguments Parse(string[] args)
		{
			...
			var parameters = getParameters(hasLocation, args);
			return new Arguments(location, command, parameters);
		}
		...
		private static string getParameters(bool hasLocation, string[] args)
		{
		...
		public Arguments(string location, string command, string parameters)
		{
			Location = location;
			Command = command;
